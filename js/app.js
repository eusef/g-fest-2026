...
(function () {
  ...
  // Footer with a link to the project source. innerHTML is safe here — the markup
  // is a fixed constant (the GitHub mark + a hard-coded repo URL), never user input.
  function appFooter() {
    var footer = el('footer', { class: 'app-footer' });
    footer.innerHTML =
      '<a class="app-footer__link" href="https://github.com/eusef/g-fest-2026" target="_blank" rel="noopener">' +
